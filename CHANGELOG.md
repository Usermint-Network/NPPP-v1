...
This is the initial stable release of the NPPP v1 protocol.

### Features

- **Canonical OpenAPI:** A standardized OpenAPI specification for all interactions.
- **Stateless Verification:** Verification is a pure function, requiring no state.
- **Audit-Grade Hardening:** The protocol has been hardened for security and auditability.
